...
entrance_block0:                                             
    ...
    store i32 5, i32 %mem2reg2
    store i32 %mem2reg0, i32 %mem2reg4
    store i32 %mem2reg2, i32 %mem2reg5
    %add = add i32 mem2reg5, 1
    store i32 %add, i32 %mem2reg2
    store i32 %mem2reg5, i32 %mem2reg0
    store i32 %mem2reg1, i32 %mem2reg6
    store i32 %mem2reg0, i32 %mem2reg7
    store i32 %mem2reg7, i32 %mem2reg1
    store i32 %mem2reg1, i32 %mem2reg8
    store i32 %mem2reg0, i32 %mem2reg9
    %add_0 = add i32 mem2reg8, mem2reg9
    store i32 %mem2reg2, i32 %mem2reg10
    %add_1 = add i32 %add_0, mem2reg10
    call void @printlnInt(i32 %add_1)
    br label %return_block0

return_block0:                                               ; preds = entrance_block0 
    store i32 %mem2reg3, i32 %mem2reg11
    ret i32 %mem2reg11
}
