...
entrance_block0:                                             
    ...
    %array_tail_addr = getelementptr inbounds i32*, i32** %array_addr, i32 4
...
for_body0:                                                   ; preds = for_condition0 
    ...
    %add = add i32 %p, 1
    store i32 %add, i32* %p_addr
    store i32 %p, i32* %getelementptr_reg_0
    br label %for_step0
...
for_body2:                                                   ; preds = for_condition2 
    ...
    %getelementptr_reg_1 = getelementptr inbounds i32*, i32** %a_0, i32 %i_5
    %load_result_1 = load i32*, i32** %getelementptr_reg_1
    %j_5 = load i32, i32* %j_addr
    %getelementptr_reg_2 = getelementptr inbounds i32, i32* %load_result_1, i32 %j_5
    %load_result_2 = load i32, i32* %getelementptr_reg_2
    call void @printlnInt(i32 %load_result_2)
    br label %for_step2
