...
entrance_block0:                                             
    ...
    store i1 false, i1* %AND_addr_7
    %AND_addr_6 = alloca i1
    store i1 false, i1* %AND_addr_6
    %AND_addr_5 = alloca i1
    store i1 false, i1* %AND_addr_5
    %AND_addr_4 = alloca i1
    store i1 false, i1* %AND_addr_4
    %AND_addr_3 = alloca i1
    store i1 false, i1* %AND_addr_3
    %AND_addr_2 = alloca i1
    store i1 false, i1* %AND_addr_2
    %AND_addr_1 = alloca i1
    store i1 false, i1* %AND_addr_1
    %AND_addr_0 = alloca i1
    store i1 false, i1* %AND_addr_0
    %AND_addr = alloca i1
    store i1 false, i1* %AND_addr
    %OR_addr_1 = alloca i1
    store i1 false, i1* %OR_addr_1
    %OR_addr_0 = alloca i1
    store i1 false, i1* %OR_addr_0
    %OR_addr = alloca i1
