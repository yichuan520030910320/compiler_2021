...
new_condition:                                               ; preds = new_loop_body entrance_block0 
    ...
    %addr_cmp_result = icmp slt i32 %load_tmp_ptr_cnt, %n_0
    br i1 %addr_cmp_result, label %new_loop_body, label %new_end

new_loop_body:                                               ; preds = new_condition 
    %geparrayaddr = getelementptr inbounds i32*, i32** %array_addr, i32 %load_tmp_ptr_cnt
    ...
    %add_one_ptr = add i32 %load_tmp_ptr_cnt, 1
    store i32 %add_one_ptr, i32* %arrayptrcnt
    br label %new_condition
