...
entrance_block0:                                             
    ...
    store %class.vector* null, %class.vector** %this_addr_0
...
entrance_block0:                                             
    ...
    store %class.vector* null, %class.vector** %temp_addr
    %OR_addr = alloca i1
    store i1 false, i1* %OR_addr
    %this_addr_0 = alloca %class.vector*
    store %class.vector* null, %class.vector** %this_addr_0
    %rhs_addr = alloca %class.vector*
    store %class.vector* null, %class.vector** %rhs_addr
...
entrance_block0:                                             
    ...
    store %class.vector* null, %class.vector** %y_addr
    %i_addr = alloca i32
    store i32 0, i32* %i_addr
    %a_addr = alloca i32*
    store i32* null, i32** %a_addr
    %x_addr = alloca %class.vector*
    store %class.vector* null, %class.vector** %x_addr
    %return_register_infunction_addr = alloca i32
    store i32 0, i32* %return_register_infunction_addr
    %class_malloc = call i8* @_f_malloc(i32 8)
    %class_ptr = bitcast i8* %class_malloc to %class.vector*
...
entrance_block0:                                             
    ...
    store i32 0, i32* %i_addr
    %temp_addr = alloca i8*
    store i8* null, i8** %temp_addr
    %this_addr_0 = alloca %class.vector*
    store %class.vector* null, %class.vector** %this_addr_0
    %return_register_infunction_addr = alloca i8*
    store i8* null, i8** %return_register_infunction_addr
    store %class.vector* %this, %class.vector** %this_addr_0
...
entrance_block0:                                             
    ...
    store i32 0, i32* %value_addr
    %idx_addr = alloca i32
    store i32 0, i32* %idx_addr
    %return_register_infunction_addr = alloca i1
    store i1 false, i1* %return_register_infunction_addr
