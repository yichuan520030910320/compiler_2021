...
entrance_block0:                                             
    %this_addr = alloca %class.vector*
    %return_register_infunction_addr = alloca i32
    store %class.vector* %this, %class.vector** %this_addr
    %this_reg = load %class.vector*, %class.vector** %this_addr
...
entrance_block0:                                             
    ...
    store %class.vector* %this, %class.vector** %this_addr
    %Implicit_call_inclass = load %class.vector*, %class.vector** %this_addr
...
short_circuit_OR_branch_OR:                                  ; preds = entrance_block0 
    %Implicit_call_inclass_0 = load %class.vector*, %class.vector** %this_addr
...
if_withoutelse_end_basicblock:                               ; preds = single_then_basicblock short_circuit_OR_end_OR 
    ...
    %Implicit_call_inclass_1 = load %class.vector*, %class.vector** %this_addr
...
for_condition:                                               ; preds = if_withoutelse_end_basicblock for_step 
    ...
    %Implicit_call_inclass_2 = load %class.vector*, %class.vector** %this_addr
...
for_body:                                                    ; preds = for_condition 
    %thisexpr_reg = load %class.vector*, %class.vector** %this_addr
    ...
    %thisexpr_reg_0 = load %class.vector*, %class.vector** %this_addr
...
for_end_merge:                                               ; preds = for_condition 
    %thisexpr_reg_1 = load %class.vector*, %class.vector** %this_addr
...
else_basicblock:                                             ; preds = if_withoutelse_end_basicblock 
    %this_reg_0 = load %class.vector*, %class.vector** %this_addr
